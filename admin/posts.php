...
session_start();
 if (!isset($_SESSION["admin"])) {
    ...
    $adminObj = new Admin();
    $list = $adminObj->displayPost();  
    if (isset($_GET["delete"])) {
        $adminObj->deleteArticle($_GET["delete"]);
    }
}
                                    ...
                                    <tbody>
                                        <?php foreach ($list as $value) {?>
                                            <tr>
                                                ...
                                                <td><?php echo $value["article_date"]; ?></td>
                                                <td><a class="delete_link" href="javascript:void(0)" rel="<?php echo $value["article_id"]; ?>"><i class="fa fa-trash text-danger"></i></a> </td>
                                            </tr>
                                        <?php } ?>
